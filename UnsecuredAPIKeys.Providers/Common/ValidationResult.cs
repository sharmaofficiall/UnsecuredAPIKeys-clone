...
namespace UnsecuredAPIKeys.Providers.Common
{
    public enum ValidationAttemptStatus
    {
        ...
        ValidNoCredits,        // The key is valid but has no credits/quota
    ...
    public class ValidationResult
    {
        ...
        public static ValidationResult ValidNoCredits(HttpStatusCode statusCode, List<ModelInfo>? models = null) =>
            new() { Status = ValidationAttemptStatus.ValidNoCredits, HttpStatusCode = statusCode, AvailableModels = models };
